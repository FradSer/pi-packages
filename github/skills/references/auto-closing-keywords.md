...
`Closes`/`Fixes`/`Resolves #N` in a PR body or commit message tells GitHub to close the linked issue when the PR merges. This is the single authoritative reference for all `/skill:*` skills.
