...
- Every published package source or runtime behavior update must have a Changeset entry for that package; the GitHub Actions flow creates the version PR and applies the version bump. Do not hand-edit package versions for ordinary changes.
