...
Publish the approved tickets. **How** depends on the tracker [setup-matt-pocock-skills](setup-matt-pocock-skills.md) configured — the tickets are the same either way, only the shape of the blocking edges changes:
