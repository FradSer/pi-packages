...
- **No sleep-based waiting guidance**: terminal reports arrive automatically, so the leader should not use `sleep`, polling, or unsolicited steers to wait for a teammate; it should continue independent work or end its turn.
