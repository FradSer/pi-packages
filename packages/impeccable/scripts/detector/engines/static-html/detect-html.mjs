// Modified for @fradser/pi-impeccable: fail on missing parser dependencies; no degraded-success fallback.
...
async function detectHtml(filePath, options = {}) {
  ...
  try {
    ...
    throw new Error('Static HTML parser dependencies are unavailable. Reinstall @fradser/pi-impeccable with its production dependencies (htmlparser2, css-select, css-tree, domutils).', { cause: error });
  }
