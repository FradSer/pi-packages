// Modified for @fradser/pi-impeccable: Pi-adapted picker vocabulary: shipped actions only.
 ...
 *
 * Pi adaptation (@fradser/pi-impeccable): the picker exposes only actions whose
 * guidance is shipped in this package; unsupported upstream verbs are removed
 * rather than advertised as unavailable.
 *
