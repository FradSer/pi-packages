#!/usr/bin/env node
// Modified for @fradser/pi-impeccable: Pi-adapted provider list and usage.
...
async function main() {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log('Usage: node live-commit-manual-edits.mjs [--page-url=<url>] [--provider=auto|pi|codex|claude|mock]');
    process.exit(0);
  }
