# Code Context Package Development Guide

## Research before modifying this package

Before editing `packages/code-context/`, classify the change and use the applicable native context tool first. These are Pi extension tools, not MCP servers:
