---
name: update-readme
description: Updates README.md and README.zh-CN.md to reflect the project's current state. Use this skill whenever the user asks to update the README, sync the docs, update documentation, or reflect latest changes in README.
