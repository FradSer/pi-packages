...
- [ ] What enters the driving session's own context stays a bounded tail plus the terminal result, delivered as a follow-up message so it becomes part of that conversation.
