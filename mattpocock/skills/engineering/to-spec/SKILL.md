...
Executable scenarios derived from the user stories above, written as Gherkin (Given/When/Then). Each scenario pins one behavior; collectively they are the executable specification the implementation is verified against. See `/skill:bdd` for the scenario authoring guide and the `.feature` storage convention.
